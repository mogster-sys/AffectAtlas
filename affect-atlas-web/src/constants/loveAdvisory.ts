...
export const LOVE_ADVISORY: EmotionAdvisory = {
  ...
  colors: {
    ...
    rationale:
      'Stitch rendered the palette as five joined swatches: Blush Cream (#fdf6f2), Warm Rose (#c0707a), Champagne Gold (#b09060), Deep Wine (#7a2848), and Intimate Dark (#3a2830). Stitch shifted primary to #8d4650 (a more muted mauve-rose) in its MD3 system and placed our #c0707a tones in adjusted containers. The visual palette strip faithfully renders all five requested colors. Primary #c0707a is the specific warm rose of a blush -- not aggressive red (passion without tenderness) and not baby pink (too innocent). Secondary champagne gold (#b09060) is candlelight, rings, and precious things. Tertiary deep wine (#7a2848) appears sparingly where depth and passion concentrate.',
  },
