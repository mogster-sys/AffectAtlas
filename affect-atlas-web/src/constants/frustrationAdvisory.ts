/**
 * Frustration advisory -- extracted from The design output.
 ...
 *
 * NOTE: The design auto-generated its own MD3 tokens (shifted primary to
 ...
 * researched values. The design's hard offset shadows and jitter animation
...
export const FRUSTRATION_ADVISORY: EmotionAdvisory = {
  ...
  colors: {
    ...
    rationale:
      'The design rendered the palette as five tight squares with 4px radius and hex labels: #1A1412 (Heated Dark), #C44030 (Blocked Red), #8A5A30 (Friction Brown), #C48820 (Urgent Amber), #E8DCD0 (Strained White). The intensity gradient runs from simmering to boiling over. The design shifted the primary in its MD3 system to #ffb4a8 (a lighter peach-red) and placed our #c44030 as primary-container, but the visual palette strip faithfully renders the requested values. Primary #c44030 is the specific red of access denied and operation failed. Secondary burnt umber (#8a5a30) is rust and friction. Tertiary amber (#c48820) is the warning before the block.',
  },
  ...
  typography: {
    ...
    rationale:
      'The design rendered Barlow Condensed at font-extrabold (800) for the header "FRUSTRATION" at 2.5rem with tracking 0.04em and leading 0.9 -- condensed type fighting its own wide spacing. The type scale shows "BLOCKED" at text-3xl font-black, "DEAD END" at text-xl font-bold, and "CONTAINMENT FAILURE" at text-xs font-bold tracking-tighter. Each specimen has a 2px left border in #c44030 -- a structural accent line. IBM Plex Sans appears as body text ("Utility & Precision") and in all labels at 10px bold uppercase with 0.2em tracking. The condensed form at heavy weights looks like text under pressure, squeezed into too-small a space.',
  },
  ...
  shapes: {
    ...
    rationale:
      'The design rendered four shapes: 0px, 2px, 4px (highlighted with a 2px tertiary border), and 6px. The rationale text reads: "4px is the optimal industrial radius. It maintains structural rigidness while preventing visual bleeding at high resolutions." The Tailwind config sets DEFAULT to 0.125rem (2px), lg to 0.25rem (4px). Not Anger\'s absolute zero (weaponized) but explicitly not friendly. Like metal enclosures or warning placards.',
  },
