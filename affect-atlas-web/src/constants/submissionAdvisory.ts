/**
 * Submission advisory -- extracted from The design output.
 ...
 *
 * NOTE: The design shifted primary to #41606f (darker teal-blue) and placed
 * our #7090a0 range in lighter fixed variants. The advisory uses the
 * prompt's researched palette for tokens. The design's barely-there shadows,
...
export const SUBMISSION_ADVISORY: EmotionAdvisory = {
  ...
  layout: {
    ...
    density: 'sparse',
    rationale:
      'The design created a centered, bottom-weighted composition with the wireframe showing a narrow element at top, center crosshairs, and heavier elements settling at the bottom. The note reads "centered, sparse, bottom-weighted composition." Elements feel small relative to their containers -- the design yields space rather than filling it. The centering is not grand formality but the unassuming center of someone who stands where they are told.',
  },
